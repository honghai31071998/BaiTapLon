  ...
  <?php
    if (isset ($_POST [ "timkiem"])) {
        ...
        else
        {
            ...
            $query = "select * from sach where tensach like '%$search%'or nhaxb like'%$search%' or namxb like '%$search%' or mota like '%$search%'";
            ...
            if ($num > 0 && $search != "") 
            {
                ...
                echo"<tr>";
                    ...
                    echo"<th>$row[tensach]</th>";
                    echo"<th>$row[tacgia]</th>";
                    echo"<th>$row[nhaxb] </th>";
                    echo"<th>$row[mota]</th>";
                    echo"<th>$row[namxb]</th>";
                    echo"<th><a href='chitietsach.php?id=$row[id]'style='color:red;'>Link</a></th>";
               echo" </tr>";
            $stt++;}
